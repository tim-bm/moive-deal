...
namespace MovieDeal.DataSource
{
    ...
    public partial class MoiveDataSource : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::MovieDeal.DataSource.MoiveDataSource"/> and sets the default values.
        /// </summary>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MoiveDataSource(IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}", new Dictionary<string, object>())
        {
